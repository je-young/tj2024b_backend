...
public class Student { // class s
	...
	// 2. 메소드(멤버함수) // 객체가 행위 할수있는 명령어 집합 / 묶음 * 행위
	// - 메소드 정의 / 만들기: String: 반환타입,getStudentName: 함수명, (): 매개변수생략, {}: 실행코드,
	// return: 함수종료 및 반환값
	public String getStudentName() {
		return studentName; // return 반환값;
	}

	// - 메소드 정의 / 만들기: 매개변수로 받은 새로운 학생명을 객체의 학생명에 저장 / 대입 하는 함수
	// void : 반환값이 없다는 뜻, setStudentName: 함수명, ( String name ): 매개변수 1개, {}: 실행코드,
	// return: 생략
	...
	public static void main(String[] args) {
		...
		System.out.println(studentAhn.getStudentName()); // (4) 객체내 멤버함수 / 메소드 호출
	}
